...
// Reusing AuthLogin.css since the layout is identical
    ...
    <div className="mh-auth-container">
      <div className="mh-auth-left">
        ...
        <div className="mh-auth-testimonial">
          <p className="mh-testimonial-text">
            "We switched to MeetingHub and haven't looked back. Scheduling, recording, and summarizing meetings has never been this seamless."
          </p>
          <div className="mh-testimonial-author">
             <Avatar src="/avatar-amara.png" fallback="AO" size="sm" />
             <div className="mh-author-info">
               <strong>Amara Okafor</strong>
               <span>Product Lead at Innovate</span>
             </div>
          </div>
        </div>
      </div>
      ...
      <div className="mh-auth-right">
        <div className="mh-auth-form-wrapper">
          ...
          <form onSubmit={handleSignUp} className="mh-auth-form">
            <Input 
              label="Full Name" 
              type="text" 
            ...
            <Input 
              ...
              required
            />
            <Button type="submit" fullWidth size="lg">Sign up for free</Button>
          </form>
