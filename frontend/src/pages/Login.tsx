...
export default function Login() {
  ...
  const handleLogin = async () => {
    try {
      ...
      const response: any = await apiClient.auth.authControllerLogin({
        email,
        password,
      });
      ...
      >
        <div style={{ width: "100%", maxWidth: 420 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 }}>
            <h1 style={{ fontSize: 28, fontWeight: 700, margin: 0 }}>{t("auth.loginTitle")}</h1>
          ...
          <Form form={form} layout="vertical" onFinish={handleLogin} autoComplete="off">
            ...
            <div style={{ textAlign: "right", marginBottom: 16 }}>
              <Link to="/forgot-password" style={{ color: "#3b82f6", fontSize: 13 }}>
